...
const DEFAULT_CONTENT = {
  ...
  'dvfy-text-reveal': '<dvfy-text-reveal mode="words" delay="60ms" style="font-size:var(--dvfy-text-2xl);font-weight:var(--dvfy-weight-semibold);line-height:1.4">The quick brown fox jumps over the lazy dog.</dvfy-text-reveal>',
