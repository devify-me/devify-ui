...
const DEFAULT_CONTENT = {
  ...
  'dvfy-scroll-reveal': '<div style="height:200px;overflow-y:auto;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-lg);padding:var(--dvfy-space-4)"><div style="height:200px;display:flex;align-items:end;color:var(--dvfy-text-muted);font-size:var(--dvfy-text-sm)">Scroll down ↓</div><dvfy-scroll-reveal shape="inset" direction="bottom"><dvfy-card padded><h3 style="margin:0 0 0.5rem">Scroll Reveal</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Revealed via clip-path inset tied to scroll position. Pure CSS, zero layout shift.</p></dvfy-card></dvfy-scroll-reveal><div style="height:200px"></div></div>',
