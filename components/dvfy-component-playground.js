...
const DEFAULT_CONTENT = {
  ...
  'dvfy-image-split': '<dvfy-image-split src="https://picsum.photos/seed/dvfy/800/450" alt="Landscape" style="max-width:420px;border-radius:var(--dvfy-radius-lg);overflow:hidden"><div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:0.5rem;color:var(--dvfy-text-primary);text-align:center;padding:1.5rem"><strong style="font-size:var(--dvfy-text-lg)">Hover to reveal</strong><span style="font-size:var(--dvfy-text-sm);color:var(--dvfy-text-secondary)">4-corner image split effect</span></div></dvfy-image-split>',
