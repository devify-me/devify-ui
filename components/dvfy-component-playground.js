...
const DEFAULT_CONTENT = {
  ...
  'dvfy-image-reveal': '<div style="height:220px;overflow-y:auto;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-lg);padding:var(--dvfy-space-4)"><div style="height:240px;display:flex;align-items:end;color:var(--dvfy-text-muted);font-size:var(--dvfy-text-sm)">Scroll down \u2193</div><dvfy-image-reveal><div style="width:100%;height:180px;background:linear-gradient(135deg,var(--dvfy-primary-bg,#0ea5e9),var(--dvfy-surface-raised,#1e293b));border-radius:var(--dvfy-radius-lg);display:flex;align-items:center;justify-content:center;color:#fff;font-weight:var(--dvfy-weight-semibold)">clip-path reveal</div></dvfy-image-reveal><div style="height:100px"></div></div>',
