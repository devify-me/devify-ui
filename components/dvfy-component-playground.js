...
const DEFAULT_CONTENT = {
  ...
  'dvfy-holo-card': '<dvfy-holo-card tilt padded elevated><h3 style="margin:0 0 0.5rem">Holographic Card</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Hover over this card to reveal the rainbow foil shimmer. Enable tilt for perspective tracking.</p></dvfy-holo-card>',
