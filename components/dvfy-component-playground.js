...
const DEFAULT_CONTENT = {
  ...
  'dvfy-image-reveal': '<div style="height:300px;overflow-y:auto;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-lg);padding:var(--dvfy-space-4)"><div style="height:220px;display:flex;align-items:end;color:var(--dvfy-text-muted);font-size:var(--dvfy-text-sm)">Scroll down ↓</div><dvfy-image-reveal direction="top"><img src="https://picsum.photos/seed/dvfy/600/400" alt="Scroll-revealed landscape" style="width:100%;border-radius:var(--dvfy-radius-md);display:block"></dvfy-image-reveal><div style="height:200px"></div></div>',
