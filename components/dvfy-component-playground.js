...
const DEFAULT_CONTENT = {
  ...
  'dvfy-parallax': '<dvfy-parallax factor="0.3" style="border-radius:var(--dvfy-radius-lg);height:200px"><div style="height:260px;background:linear-gradient(135deg,var(--dvfy-primary-bg),var(--dvfy-accent-bg,#7c3aed));display:flex;align-items:center;justify-content:center;color:#fff;font-size:var(--dvfy-text-xl);font-weight:var(--dvfy-weight-semibold);border-radius:var(--dvfy-radius-lg)">Parallax Layer</div></dvfy-parallax>',
