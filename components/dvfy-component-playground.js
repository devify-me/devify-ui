...
const DEFAULT_CONTENT = {
  ...
  'dvfy-radio': '<dvfy-radio name="plan" value="free" label="Free plan" checked></dvfy-radio>',
  'dvfy-switch': '<dvfy-switch label="Notifications" description="Receive email alerts" name="notify"></dvfy-switch>',
  ...
  'dvfy-badge': 'Status',
  'dvfy-tag': 'Label',
  'dvfy-avatar': '<dvfy-avatar name="Jorge Garcia" status="online"></dvfy-avatar>',
  'dvfy-alert': 'This is an alert message.',
  'dvfy-loader': '<dvfy-loader size="md"></dvfy-loader>',
  ...
  'dvfy-progress': '<dvfy-progress value="65" label></dvfy-progress>',
  ...
  'dvfy-sidebar': '',
  'dvfy-hamburger': '<dvfy-hamburger animation="x" size="md" bordered></dvfy-hamburger>',
