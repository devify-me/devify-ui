...
const DEFAULT_CONTENT = {
  ...
  'dvfy-stepper': '<dvfy-step label="Account" description="Your details"><p style="color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm);margin:0">Enter your email and password to create an account.</p></dvfy-step><dvfy-step label="Profile" description="Personal info"><p style="color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm);margin:0">Tell us a bit about yourself.</p></dvfy-step><dvfy-step label="Review" description="Confirm details"><p style="color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm);margin:0">Review your information before submitting.</p></dvfy-step>',
};
