...
const DEFAULT_CONTENT = {
  ...
  'dvfy-compare-slider': '<svg slot="before" viewBox="0 0 400 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block"><rect width="400" height="250" fill="#e8e0d8"/><circle cx="320" cy="60" r="30" fill="#f5d97a"/><rect x="40" y="140" width="80" height="110" rx="4" fill="#8fae7c"/><rect x="140" y="110" width="80" height="140" rx="4" fill="#7ca88f"/><rect x="240" y="160" width="80" height="90" rx="4" fill="#8fae7c"/><text x="200" y="30" text-anchor="middle" font-family="system-ui" font-size="14" fill="#999">Before</text></svg><svg slot="after" viewBox="0 0 400 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block"><rect width="400" height="250" fill="#1a1a2e"/><circle cx="320" cy="60" r="30" fill="#e8c547"/><rect x="40" y="140" width="80" height="110" rx="4" fill="#16a085"/><rect x="140" y="110" width="80" height="140" rx="4" fill="#1abc9c"/><rect x="240" y="160" width="80" height="90" rx="4" fill="#16a085"/><text x="200" y="30" text-anchor="middle" font-family="system-ui" font-size="14" fill="#aaa">After</text></svg>',
