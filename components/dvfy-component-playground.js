...
const DEFAULT_CONTENT = {
  ...
  'dvfy-clip-reveal': '<dvfy-clip-reveal preset="blob" trigger="auto" duration="1200" style="background:var(--dvfy-primary-bg);border-radius:var(--dvfy-radius-xl);overflow:hidden"><div style="padding:var(--dvfy-space-12);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:var(--dvfy-space-4);min-height:200px;text-align:center"><h3 style="margin:0;color:#fff;font-size:var(--dvfy-text-2xl)">Clip Reveal</h3><p style="margin:0;color:rgba(255,255,255,0.7);font-size:var(--dvfy-text-sm)">CSS shape() organic clip-path morph</p></div></dvfy-clip-reveal>',
