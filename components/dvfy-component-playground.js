...
const DEFAULT_CONTENT = {
  ...
  'dvfy-cipher-card': '<dvfy-cipher-card padded elevated style="min-height:160px"><h3 style="margin:0 0 0.5rem">Cipher Card</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Hover to reveal the decryption effect.</p></dvfy-cipher-card>',
};
