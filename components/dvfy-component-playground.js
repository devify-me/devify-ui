...
const DEFAULT_CONTENT = {
  ...
  'dvfy-wavy-underline': '<dvfy-wavy-underline style="font-size:var(--dvfy-text-xl);--dvfy-wave-color:var(--dvfy-accent-brand)">Wavy underline text</dvfy-wavy-underline>',
