...
const DEFAULT_CONTENT = {
  ...
  'dvfy-text-stagger': '<dvfy-text-stagger style="font-size:var(--dvfy-text-2xl);font-weight:var(--dvfy-weight-bold);line-height:1.3">Scroll reveal words one by one with a stagger effect</dvfy-text-stagger>',
