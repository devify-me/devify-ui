...
const DEFAULT_CONTENT = {
  ...
  'dvfy-scroll-reveal': '<div style="height:200px;overflow-y:auto;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-lg);padding:var(--dvfy-space-4)"><div style="height:220px;display:flex;align-items:flex-end;padding-bottom:var(--dvfy-space-2);color:var(--dvfy-text-muted);font-size:var(--dvfy-text-sm)">↓ Scroll down</div><dvfy-scroll-reveal direction="up"><dvfy-card padded><h3 style="margin:0 0 0.5rem">Revealed Card</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Fades up into view as you scroll. Uses <code>animation-timeline: view()</code>.</p></dvfy-card></dvfy-scroll-reveal><div style="height:120px"></div></div>',
