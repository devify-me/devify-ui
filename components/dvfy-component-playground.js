...
const DEFAULT_CONTENT = {
  ...
  'dvfy-sidebar': '<dvfy-sidebar-section label="Navigation"><a href="#">Dashboard</a><a href="#">Tasks</a><a href="#">Reports</a></dvfy-sidebar-section><dvfy-sidebar-section label="Settings"><a href="#">Profile</a><a href="#">Config</a></dvfy-sidebar-section>',
  'dvfy-hamburger': '',
  ...
  'dvfy-header': '<dvfy-hamburger slot="start"></dvfy-hamburger><dvfy-theme-switcher slot="end"><option value="devify-cyan">Cyan</option><option value="devify-pink">Pink</option></dvfy-theme-switcher><dvfy-avatar slot="end" name="Jane Doe" status="online"></dvfy-avatar>',
