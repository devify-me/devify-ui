...
const DEFAULT_CONTENT = {
  ...
  'dvfy-card-stack': '<div style="height:300px;overflow-y:auto;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-lg);padding:var(--dvfy-space-4)"><dvfy-card-stack style="--dvfy-card-stack-offset:1rem"><dvfy-card padded elevated><h3 style="margin:0 0 0.5rem">Card One</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Scroll down to see cards stack.</p><div style="height:120px"></div></dvfy-card><dvfy-card padded elevated style="background:var(--dvfy-surface-overlay)"><h3 style="margin:0 0 0.5rem">Card Two</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">This card slides over Card One.</p><div style="height:120px"></div></dvfy-card><dvfy-card padded elevated style="background:var(--dvfy-surface-sunken)"><h3 style="margin:0 0 0.5rem">Card Three</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Final card in the stack.</p><div style="height:120px"></div></dvfy-card></dvfy-card-stack></div>',
