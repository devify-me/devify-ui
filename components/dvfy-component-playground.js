...
const DEFAULT_CONTENT = {
  ...
  'dvfy-parallax': '<dvfy-parallax speed="0.4" style="--dvfy-parallax-height:40vh;border-radius:var(--dvfy-radius-xl)"><div slot="bg" style="background:linear-gradient(135deg,var(--dvfy-primary-bg,#0ea5e9),var(--dvfy-color-purple-500,#8b5cf6));width:100%;height:100%"></div><div style="display:flex;align-items:center;justify-content:center;height:40vh;color:#fff"><div style="text-align:center;padding:var(--dvfy-space-8)"><h2 style="margin:0 0 var(--dvfy-space-2);font-size:var(--dvfy-text-2xl);font-weight:var(--dvfy-weight-bold)">Parallax Section</h2><p style="margin:0;opacity:0.85;font-size:var(--dvfy-text-base)">Scroll to see the depth effect</p></div></div></dvfy-parallax>',
