...
const DEFAULT_CONTENT = {
  ...
  'dvfy-card-decrypt': '<dvfy-card-decrypt padded elevated><h3 style="margin:0 0 0.5rem">Encrypted Card</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Hover to reveal the scrambled overlay. The cursor tracks a radial window through the character matrix.</p></dvfy-card-decrypt>',
