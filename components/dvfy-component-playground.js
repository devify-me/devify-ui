...
const DEFAULT_CONTENT = {
  ...
  'dvfy-text-reveal': '<dvfy-text-reveal style="font-size:var(--dvfy-text-2xl);font-weight:var(--dvfy-weight-semibold)">Scroll-triggered staggered text reveal animation</dvfy-text-reveal>',
