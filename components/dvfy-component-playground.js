...
const DEFAULT_CONTENT = {
  ...
  'dvfy-carousel': '',
  'dvfy-stepper': '<dvfy-step label="Account" description="Create your account"><p>Enter your email and password to get started.</p></dvfy-step><dvfy-step label="Profile" description="Set up your profile"><p>Tell us about yourself.</p></dvfy-step><dvfy-step label="Confirm" description="Review and confirm"><p>Review your details and confirm.</p></dvfy-step>',
  ...
  'dvfy-tree-view': '<dvfy-tree-node label="Documents" icon="\uD83D\uDCC1" expanded><dvfy-tree-node label="README.md" icon="\uD83D\uDCC4" href="#readme"></dvfy-tree-node><dvfy-tree-node label="Images" icon="\uD83D\uDCC1"><dvfy-tree-node label="logo.png" icon="\uD83D\uDDBC\uFE0F" href="#logo"></dvfy-tree-node><dvfy-tree-node label="banner.jpg" icon="\uD83D\uDDBC\uFE0F" href="#banner"></dvfy-tree-node></dvfy-tree-node></dvfy-tree-node><dvfy-tree-node label="Settings" icon="\u2699\uFE0F" href="#settings"></dvfy-tree-node>',
