...
const DEFAULT_CONTENT = {
  ...
  'dvfy-command-palette': '<dvfy-command-palette storage-key="catalog-demo"><dvfy-command id="new-project" group="Projects" icon="\u2795" label="New project" shortcut="P"></dvfy-command><dvfy-command id="new-task" group="Projects" icon="\u2714\uFE0F" label="New task" shortcut="T"></dvfy-command><dvfy-command id="open-inbox" group="Navigate" icon="\uD83D\uDCE5" label="Open inbox" shortcut="I"></dvfy-command><dvfy-command id="go-dashboard" group="Navigate" icon="\uD83D\uDCC8" label="Dashboard"></dvfy-command><dvfy-command id="run-deploy" group="Actions" icon="\uD83D\uDE80" label="Deploy to staging"></dvfy-command></dvfy-command-palette><p style="color:var(--dvfy-text-muted);font-size:var(--dvfy-text-sm);margin:0">Press <kbd style="font-family:var(--dvfy-font-mono);background:color-mix(in srgb,var(--dvfy-text-primary) 8%,transparent);border:1px solid var(--dvfy-border-subtle);border-radius:3px;padding:0.1em 0.35em">Ctrl+K</kbd> to open. Selections are tracked — frequently-used commands float to the top.</p>',
  'dvfy-smart-suggest': '<dvfy-smart-suggest context="task-detail" label="Suggested next steps"><dvfy-suggestion id="assign" icon="\uD83D\uDC64" label="Assign member"></dvfy-suggestion><dvfy-suggestion id="set-due" icon="\uD83D\uDCC5" label="Set due date"></dvfy-suggestion><dvfy-suggestion id="add-label" icon="\uD83C\uDFF7\uFE0F" label="Add label"></dvfy-suggestion><dvfy-suggestion id="attach" icon="\uD83D\uDCCE" label="Attach file"></dvfy-suggestion></dvfy-smart-suggest>',
};
