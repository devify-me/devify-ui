...
const DEFAULT_CONTENT = {
  ...
  'dvfy-spotlight-reveal': '<dvfy-spotlight-reveal size="150" style="border-radius:var(--dvfy-radius-lg);overflow:hidden"><div slot="base" style="background:var(--dvfy-surface-raised);padding:var(--dvfy-space-8);text-align:center;font-size:var(--dvfy-text-xl);color:var(--dvfy-text-muted);min-height:200px;display:flex;align-items:center;justify-content:center">Base Layer — move cursor to reveal</div><div style="background:var(--dvfy-primary-bg);color:#fff;padding:var(--dvfy-space-8);text-align:center;font-size:var(--dvfy-text-xl);font-weight:var(--dvfy-weight-semibold);min-height:200px;display:flex;align-items:center;justify-content:center">Revealed Layer</div></dvfy-spotlight-reveal>',
};
