...
const DEFAULT_CONTENT = {
  ...
  'dvfy-clip-reveal': '<div style="height:160px;overflow-y:auto;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-lg);padding:var(--dvfy-space-4)"><div style="height:200px;display:flex;align-items:end;color:var(--dvfy-text-muted);font-size:var(--dvfy-text-sm)">Scroll down</div><dvfy-clip-reveal direction="bottom"><dvfy-card padded><h3 style="margin:0 0 0.5rem">Clip Reveal</h3><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Wipes in via CSS @property clip-path on scroll.</p></dvfy-card></dvfy-clip-reveal><div style="height:200px"></div></div>',
