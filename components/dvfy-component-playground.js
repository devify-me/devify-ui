...
const DEFAULT_CONTENT = {
  ...
  'dvfy-stagger-list': '<dvfy-stagger-list style="display:grid;grid-template-columns:repeat(3,1fr);gap:var(--dvfy-space-4)"><dvfy-card padded><h4 style="margin:0 0 0.25rem">Alpha</h4><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">First card fades in.</p></dvfy-card><dvfy-card padded><h4 style="margin:0 0 0.25rem">Beta</h4><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Second follows.</p></dvfy-card><dvfy-card padded><h4 style="margin:0 0 0.25rem">Gamma</h4><p style="margin:0;color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm)">Third arrives last.</p></dvfy-card></dvfy-stagger-list>',
};
