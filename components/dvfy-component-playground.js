...
const DEFAULT_CONTENT = {
  ...
  'dvfy-clip-animate': '<div style="height:300px;overflow-y:auto;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-lg);padding:var(--dvfy-space-4)"><div style="height:200px;display:flex;align-items:end;color:var(--dvfy-text-muted);font-size:var(--dvfy-text-sm)">Scroll down to reveal</div><dvfy-clip-animate style="margin:var(--dvfy-space-4) 0"><div style="background:var(--dvfy-primary-bg);color:#fff;border-radius:var(--dvfy-radius-lg);padding:var(--dvfy-space-8);font-size:var(--dvfy-text-lg);font-weight:var(--dvfy-weight-semibold)">Circle reveal on scroll — powered by @property + animation-timeline: view()</div></dvfy-clip-animate><div style="height:200px"></div></div>',
