...
const DEFAULT_CONTENT = {
  ...
  'dvfy-sticky-header': '<dvfy-sticky-header style="position:relative;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-lg)"><span style="font-weight:var(--dvfy-weight-bold);font-size:var(--dvfy-text-lg)">My App</span><nav style="display:flex;gap:var(--dvfy-space-4);margin-inline-start:auto"><a href="#" style="color:var(--dvfy-text-primary);text-decoration:none">Home</a><a href="#" style="color:var(--dvfy-text-primary);text-decoration:none">About</a></nav></dvfy-sticky-header><p style="color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm);margin:var(--dvfy-space-3) 0 0">Scroll the page to see the header shrink. Requires browser support for <code>animation-timeline: scroll()</code>.</p>',
