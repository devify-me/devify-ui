...
const DEFAULT_CONTENT = {
  ...
  'dvfy-command-palette': '<button onclick="this.nextElementSibling.setAttribute(\'open\',\'\')" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.5rem 1rem;border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-md);background:var(--dvfy-surface-raised);color:var(--dvfy-text-secondary);font-size:var(--dvfy-text-sm);cursor:pointer">Search <kbd style="background:var(--dvfy-surface-sunken);border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-sm);padding:0.1rem 0.35rem;font-size:0.75em;font-family:var(--dvfy-font-mono)">\u2318K</kbd></button><dvfy-command-palette placeholder="Search commands\u2026"><dvfy-command-group label="Navigation"><dvfy-command-item value="home" icon="\uD83C\uDFE0" shortcut="\u2318H">Home</dvfy-command-item><dvfy-command-item value="settings" icon="\u2699\uFE0F" shortcut="\u2318,">Settings</dvfy-command-item><dvfy-command-item value="profile" icon="\uD83D\uDC64">Profile</dvfy-command-item></dvfy-command-group><dvfy-command-group label="Actions"><dvfy-command-item value="new-file" icon="\uD83D\uDCC4" shortcut="\u2318N" keywords="create add">New File</dvfy-command-item><dvfy-command-item value="search" icon="\uD83D\uDD0D" shortcut="\u2318F" keywords="find">Search</dvfy-command-item><dvfy-command-item value="theme" icon="\uD83C\uDFA8" keywords="colors dark light">Toggle Theme</dvfy-command-item></dvfy-command-group></dvfy-command-palette>',
};
