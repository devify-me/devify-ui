...
const DEFAULT_CONTENT = {
  ...
  'dvfy-stack-cards': '<dvfy-stack-cards style="--dvfy-stack-item-height:60vh"><div style="background:var(--dvfy-primary-bg);color:#fff;border-radius:var(--dvfy-radius-xl);padding:var(--dvfy-space-12);min-height:220px;display:flex;align-items:center;justify-content:center;font-size:var(--dvfy-text-2xl);font-weight:var(--dvfy-weight-bold)">Card 1</div><div style="background:var(--dvfy-surface-raised);border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-xl);padding:var(--dvfy-space-12);min-height:220px;display:flex;align-items:center;justify-content:center;font-size:var(--dvfy-text-2xl);font-weight:var(--dvfy-weight-bold)">Card 2</div><div style="background:var(--dvfy-surface-sunken);border:1px solid var(--dvfy-border-default);border-radius:var(--dvfy-radius-xl);padding:var(--dvfy-space-12);min-height:220px;display:flex;align-items:center;justify-content:center;font-size:var(--dvfy-text-2xl);font-weight:var(--dvfy-weight-bold)">Card 3</div></dvfy-stack-cards>',
