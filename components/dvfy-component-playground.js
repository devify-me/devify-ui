...
const DEFAULT_CONTENT = {
  ...
  'dvfy-compare-slider': '<dvfy-compare-slider style="aspect-ratio:16/9;max-width:600px"><div slot="before" style="width:100%;height:100%;background:linear-gradient(135deg,var(--dvfy-cyan-700,#0e7490),var(--dvfy-indigo-700,#4338ca));display:flex;align-items:center;justify-content:center;color:#fff;font-size:var(--dvfy-text-lg,1.125rem);font-weight:600">Before</div><div slot="after" style="width:100%;height:100%;background:linear-gradient(135deg,var(--dvfy-indigo-700,#4338ca),var(--dvfy-cyan-700,#0e7490));display:flex;align-items:center;justify-content:center;color:#fff;font-size:var(--dvfy-text-lg,1.125rem);font-weight:600">After</div></dvfy-compare-slider>',
};
