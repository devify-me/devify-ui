...
const DEFAULT_CONTENT = {
  ...
  'dvfy-radio': '',
  'dvfy-switch': '',
  'dvfy-slider': '<dvfy-slider label="Volume" value="50" fill show-value></dvfy-slider>\n<dvfy-slider label="Opacity" min="0" max="1" step="0.01" value="0.5" variant="oval" fill show-value></dvfy-slider>\n<dvfy-slider label="Knobs Only" value="40" show-value></dvfy-slider>\n<dvfy-slider label="Price Range" min="0" max="1000" value="200" value-end="800" range fill show-value></dvfy-slider>\n<dvfy-slider label="Range (no fill)" min="0" max="100" value="25" value-end="75" range show-value></dvfy-slider>\n<dvfy-slider label="Rating" min="0" max="10" steps="10" value="5" show-value></dvfy-slider>\n<dvfy-slider label="Disabled" value="30" fill disabled show-value></dvfy-slider>',
  'dvfy-badge': 'Status',
  'dvfy-tag': 'Label',
  'dvfy-avatar': '',
