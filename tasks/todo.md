...
a new Layout **category `capture`** (one shared no-nav shell) + two OR-set Widgets.
...
- [x] components/dvfy-capture-page.js — Layout (category capture, pageRole capture) via helper
- [x] tests: dvfy-optin.test.js, dvfy-thank-you.test.js, dvfy-capture-page.test.js (54 tests)
...
- [x] examples/capture-funnel/ (capture.html + thank-you.html) — neutral thermometer offer
...
- capture-page shares utils/no-nav-shell.js; campaign-layout LEFT UNTOUCHED (keep tests green).
